...
- [docs/local-inference.md](docs/local-inference.md) - opt-in local-inference catalog inspection, hardware capacity ranking, and loopback `/models` probe boundaries.
