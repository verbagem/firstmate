...
- Decision cards that present agent-initiated proposal cards should use the proposal card's rendered decision-time label and route any rejection note through the existing answer path; `bin/fm-proposal-card.sh` owns that proposal-card contract.
